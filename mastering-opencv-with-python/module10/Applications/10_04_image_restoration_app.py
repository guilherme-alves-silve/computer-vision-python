...
if uploaded_file is not None:
    ...
    option = st.sidebar.selectbox(
        "Median or Bilateral Blur or Inpaint?", ("None", "Median Blur", "Bilateral Blur", "Image Inpaint")
    )
    ...
    if option == "Median Blur":
        ...
        if option == "Telea":
            ...
            if res1 is not None:
                ...
                st.sidebar.markdown(
                    get_image_download_link(result1, "telea.png", "Download Output of Telea"), unsafe_allow_html=True
                )
            if res2 is not None:
                # Display link.
